const CACHE='lmos-v92-0-0-release-candidate';
const ASSETS=[
  './','./index.html','./manifest.webmanifest',
  './css/styles.css?v=92.1.0','./css/modules/lots.css?v=75.1.0','./css/modules/field-book.css?v=75.1.0','./css/modules/hydric-center.css?v=75.1.0','./css/modules/premium-home.css?v=75.1.0',
  './js/app.js?v=92.1.0','./js/auth.js?v=92.1.0','./js/supabase-client.js?v=75.1.0',
  ...
  './js/modules/purchases/index.js','./js/modules/resources/index.js','./js/modules/finance/index.js','./js/modules/data-safety/index.js','./js/modules/establishment/index.js','./js/modules/hydric-intelligence/index.js?v=92.1.0','./js/services/hydric-state.js?v=92.1.0','./js/modules/premium-home/index.js?v=92.1.0','./js/modules/laboratory-intelligent/index.js?v=92.1.0'
];
